          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@anjolaaesthetics.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <button className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-pink-100 transition">
                ...
                <button className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-pink-100 transition">
                  <Twitter className="w-6 h-6 text-pink-400" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full bg-gradient-to-r from-pink-400 to-purple-400 text-white py-3 rounded-lg hover:from-pink-500 hover:to-purple-500 transition">
                  Send Message
                </button>
              </form>
            )}
